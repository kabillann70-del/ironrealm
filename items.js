...
const ITEMS = {
    ...
    wood_sword: { name: 'Wood Sword', type: 'weapon', weaponType: 'sword', dmg: 15, image: 'https://e1.pngegg.com/pngimages/228/288/png-clipart-minecraft-icon-1-4-wooden-sword-brown-sword-art.png', sellValue: 20, price: 50 },
    novice_axe: { name: 'Novice Axe', type: 'weapon', toolType: 'tree', weaponType: 'axe', dmg: 10, image: 'https://opengameart.org/sites/default/files/item_stoneaxe.png', sellValue: 15, price: 40 }
};
const MONSTER_TYPES = {
    wolf: { hp: 50, dmg: 5, speed: 2.2, xp: 30, gold: [5, 12], color: 0x777777, drops: [{ item: 'raw_wood', chance: 0.3 }] },
    ogre: { hp: 200, dmg: 15, speed: 1.0, xp: 120, gold: [30, 60], color: 0x553300, drops: [{ item: 'ogre_bone', chance: 0.5 }, { item: 'wood_sword', chance: 0.1 }] }
};
